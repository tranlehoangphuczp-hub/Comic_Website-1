      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-center py-6 gap-4">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold text-gray-800 mb-1">Comic</h2>
            <p className="text-sm text-gray-600 max-w-md">
              Your ultimate destination for free online comics
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-3">
              <a href="#" className="text-gray-400 hover:text-purple-950 transition-colors duration-200">
        ...
        <div className="border-t border-gray-200 py-4 text-center">
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} Comic. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
